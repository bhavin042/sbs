...
<body>
	<h2>Display Users</h2>
	<form:form method="POST" id="authProfile" action="/SBS/authUser" commandName="authProfile" 
	onsubmit="return validateUserName(this);">
		...
		<table>
			...
			<tr>
				<td colspan="2"><input type ="submit" onclick="form.action='/SBS/authTrans';" value="Authenticate User" /></td>
			</tr>
