...
<script type="text/javascript">
	...
	{
	var userName=document.forms["transfer"]["UserName"].value;
	...
	{
	var balance=document.forms["transfer"]["balance"].value;
...
<form name="transfer" action="/SBS/AmountTransfer" id="TransferAmount" method="post" >
       <table>
       <tr>
       ...
       <tr>
				...
				<td align="left">
				<input name="UserName" type="text" autocomplete="off"  onBlur="val_UserName()"/></td>
				<td align="left">
