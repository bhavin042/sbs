...
<body>
	<h2>Display Users</h2>
	<form:form method="POST" id="dispProfile" action="/SBS/displayUser" commandName="dispProfile" 
	onsubmit="return validateUserName(this);">
		...
		<table border="1">
			...
			<tr>
				<td colspan="2"><input type ="submit" onclick="form.action='/SBS/addUser';" value="Add User" /></td>
			</tr>
